	...
	public static void main(String[] args) 
	{
		...
		try {			
			do
			{
				...
				System.out.println("Category 3, RESULT add1 = " + r);
				r = calc1.divide(7, 8);
				System.out.println("Category 3, RESULT divide = " + r);
				r = calc1.multiply(7, 8);
				System.out.println("Category 3, RESULT multiply = " + r);
				r = calc1.modulo(7, 8);
				System.out.println("Category 3, RESULT modulo = " + r);
				r = calc1.subtract(7, 8);
				System.out.println("Category 3, RESULT subtract = " + r);
