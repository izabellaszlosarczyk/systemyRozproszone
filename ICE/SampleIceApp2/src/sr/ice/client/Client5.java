		...
		try {
			...
			do
			{
				...
				for (int j = 0; j < random.nextInt(6); j++) {
					...
					System.out.println("Category 5, RESULT add1 = " + r);
					r = calc1.divide(7, 8);
					System.out.println("Category 5, RESULT divide = " + r);
					r = calc1.multiply(7, 8);
					System.out.println("Category 5, RESULT multiply = " + r);
					r = calc1.modulo(7, 8);
					System.out.println("Category 5, RESULT modulo = " + r);
					r = calc1.subtract(7, 8);
					System.out.println("Category 5, RESULT subtract = " + r);
