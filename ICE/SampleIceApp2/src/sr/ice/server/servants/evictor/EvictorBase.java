package sr.ice.server.servants.evictor;
...
public abstract class EvictorBase implements Ice.ServantLocator {
	...
	public abstract void evict(Ice.Object servant, java.lang.Object cookie, Identity id);
	...
	private void evictServants() {
		...
		for (int i = 0; i < excessEntries; ++i) {
			...
			if (e.useCount == 0) {
				evict(e.servant, e.userCookie, id); // Down-call
				e.queuePos.remove();
				_map.remove(id);
			}
		}
